...
<br/>
<br/>
<Button  disabled={isSubmitting} type="submit" color="success" variant="contained" style={{width:'100%',padding:'12px'}}>DELETE EMPLOYEE</Button>
<br/>
<br/>
</Grid>
...
<br/>
<br/>
<Button onClick={() => navigate2(-1)}  color="success" variant="outlined" style={{width:'100%',padding:'12px'}}>back</Button>
<br/>
<br/>
</Grid>
      </Grid>
